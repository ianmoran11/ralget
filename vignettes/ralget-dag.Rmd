...
```{r}
a <- v("a", .func = ~ rnorm(n = 1000, mean = rsum(.x), sd = .5))
c <- v("c", .f = ~ rnorm(n = 1000, mean = rsum(.x), sd = .5))
x <- v("x", .f = ~ rnorm(n = 1000, mean = rsum(.x), sd = .5))
y <- v("y", .f = ~ rnorm(n = 1000, mean = rsum(.x), sd = .5))
m <- v("m", .f = ~ rnorm(n = 1000, mean = rsum(.x), sd = .5))
